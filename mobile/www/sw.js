...
const CACHE_VERSION = 'smyl-v81-auto-smile-localizer';
...
const STATIC_FILES = [
  ...
  '/camila/visual-simulation.js?v=21',
  '/camila/demo/smyl-paciente-chuecos-v1/01-frontal-sonrisa.png',
  '/camila/demo/smyl-paciente-chuecos-v1/02-perfil-derecho.png',
  '/camila/demo/smyl-paciente-chuecos-v1/03-perfil-izquierdo.png',
  '/camila/demo/smyl-paciente-chuecos-v1/04-vista-3-4.png',
  '/camila/demo/smyl-paciente-chuecos-v1/05-intraoral-dientes.png',
  '/camila/demo/smyl-paciente-chuecos-v1/06-extraoral-rostro.png',
  '/camila/demo/smyl-paciente-chuecos-v2/01-frontal-rostro.png',
  '/camila/demo/smyl-paciente-chuecos-v2/02-intraoral-frontal.png',
