...
const STATIC_FILES = [
  ...
  '/camila/icons/dental-library/natural-a1-v1/central-r1.png',
  '/camila/icons/dental-library/natural-a1-v1/lateral-r1.png',
  '/camila/icons/dental-library/natural-a1-v1/canine-r1.png',
